  ...
  return (
    <div className="flex">
      <Drawer>
        ...
        <DrawerContent className="!pt-0 !mt-0  flex flex-col items-center justify-between max-h-[80vh] min-h-[40vh] overflow-y-auto">
          <div className="w-full flex flex-col flex-1 overflow-y-auto inner-drawer items-center justify-start">
            <DrawerHeader>
              <DrawerTitle>Recent Logs</DrawerTitle>
              <DrawerDescription>Edit your logs</DrawerDescription>
            </DrawerHeader>

            <div className="p-4 pb-0 flex-1 overflow-y-auto relative w-full px-10">
            ...
            <DrawerFooter className="flex items-end px-10 w-full">
              <DrawerClose asChild>
